package com.huzair.tokopedia.service;

import com.fasterxml.jackson.dataformat.csv.CsvMapper;
import com.fasterxml.jackson.dataformat.csv.CsvSchema;
import com.huzair.tokopedia.config.WebDriverConfig;
import com.huzair.tokopedia.model.Product;
...
import static com.huzair.tokopedia.utils.Strings.*;

public class ScrapService {
    public String downloadProductListCsv()
            throws ScrapperException {
        String filename = PRODUCT + UNDERSCORE + "LAPTOP"
        ...
        try {
            ...
            throw new ScrapperException(e.getMessage());
        }
    }
